...
EXECUTE sp_addextendedproperty 
   @name = N'MS_Description', @value = 'If treatment was stopped due to adverse event from TB treatment indicates the severity.',
   @level0type = N'SCHEMA',   @level0name = N'Clinical',
   @level1type = N'TABLE',    @level1name = N'Severity_Code';
GO
