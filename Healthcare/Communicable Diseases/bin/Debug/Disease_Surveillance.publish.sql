...
GO
PRINT N'Creating Table [dbo].[App_Message_Code]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[App_Message_Code]...';


GO
ALTER TABLE [dbo].[App_Message_Code]
    ADD DEFAULT 'COMMON' FOR [Tenant_ID];
