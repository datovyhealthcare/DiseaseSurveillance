...
GO
PRINT N'Creating Table [dbo].[Assignment_Link]...';
...
GO
PRINT N'Creating Table [dbo].[Region_Code]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Assignment_Link]...';


GO
ALTER TABLE [dbo].[Assignment_Link]
    ADD DEFAULT 'COMMON' FOR [Tenant_ID];
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Region_Code]...';


GO
ALTER TABLE [dbo].[Region_Code]
...
GO
PRINT N'Creating Foreign Key [dbo].[fk_Assignment_Link]...';
